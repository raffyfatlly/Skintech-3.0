...
export const generateRetouchedImage = async (imageBase64: string): Promise<string> => {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    { text: "Image Editing Task. Do NOT generate a new image. 1. STRICTLY PRESERVE the original image geometry, aspect ratio, and zoom level. Do not crop. 2. The output MUST align pixel-for-pixel with the input. Do NOT shift facial features. 3. Retouch ONLY the skin texture (reduce acne, redness, bumps). 4. Do NOT touch lips, eyes, eyebrows, hair, or background. Lips must remain 100% original. 5. Maintain natural skin pores (no blur/plastic look). Goal: 'Healthy, clean skin' overlay." }
                ]
            }
    ...
    }, 90000); // Increased timeout to 90s for image processing
};
